...
# info user 
print('Qui vedrai il password e il nome del file in temporeale ')
...
class windows:
    def __init__(self):
        ...
        self.lunghezza.place(x=30,y=38,height=30, width=120)
...
Per altri software clicca sul bottone qui sotto
        ...
        def g_password():
                try:
                    ...
                    # label info user 
                    self.text1=tk.Label(root5,text='Qui vedrai in anteprima password e i nomi del file:',bg='white')
        ...
        self.bt_ok.place(x=170,y=38)
        self.bt_info=tk.Button(root,text='INFO',command=info,bg='white',activebackground='white',relief='flat')
        self.bt_info.place(x=170,y=78)
        root.mainloop()
